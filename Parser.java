...
public class Parser {
    ...
    private boolean E1() {
        return E9() && term(Token.PLUS) && E();
    }

    private boolean E2() {
        return E9() && term(Token.MINUS) && E();
    }

    private boolean E3() {
        return E9() && term(Token.MULT) && E();
    }

    private boolean E4() {
        return E9() && term(Token.DIV) && E();
    }

    private boolean E5() {
        return E9() && term(Token.MOD) && E();
    }

    private boolean E6() {
        return E9() && term(Token.EXP) && E();
    }
